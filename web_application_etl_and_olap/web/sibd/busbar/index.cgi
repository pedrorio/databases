...
class Index:
    ...
    def process(self):
        try:
            ...
            title = 'List of Bus Bars'
            template = self.templates.get_template('busbar/index.jinja2')
            print(template.render(title=title, busbars=busbars, website_root=self.config.website_root))
