...
class Index:
    ...
    def process(self):
        try:
            ...
            template = self.templates.get_template('transformer/index.jinja2')
            print(template.render(title=title, transformers=transformers, website_root=self.config.website_root))
